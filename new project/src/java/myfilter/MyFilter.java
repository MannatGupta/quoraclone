...
if (debug) {
        ...
        System.out.println("Here...Filter was called\n");
        System.out.println("Here are the parameters it recieved(from request)");
        ...
        response.getWriter().write("This is something written by MyFilter");
